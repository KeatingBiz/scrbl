// components/views/ClassesView.tsx
"use client";
...
export default function ClassesView() {
  ...
  function openItem(it: SavedItem) {
    sessionStorage.setItem("scrbl:lastImage", it.thumbDataUrl);
    sessionStorage.setItem("scrbl:lastResult", JSON.stringify(it.result));
    location.assign("/result");
  }

  return (
    <div className="min-h-[calc(100vh-12rem)] p-6 flex flex-col items-center gap-6">
